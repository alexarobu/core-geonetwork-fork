<xsl:stylesheet version="2.0"
  ...
  <xsl:param name="baseUrl" select="''"/>
      ...
      <!-- i18n information -->
  <xsl:variable name="suggest-iso19115-3_2018-schemaupgrade-loc">
    <msg id="a" xml:lang="eng">Schema is ISO19110.</msg>
    <msg id="a" xml:lang="eng">Run this task to convert it to ISO19115-3.</msg>
  </xsl:variable>

    <xsl:template name="list-suggest-iso19115-3_2018-schemaupgrade">
    <suggestion process="suggest-iso19115-3_2018-schemaupgrade"/>
  </xsl:template>

  <xsl:template name="analyze-suggest-iso19115-3_2018-schemaupgrade">
        <xsl:param name="root"/>
        <suggestion process="suggest-iso19115-3_2018-schemaupgrade" id="{generate-id()}" category="metadata"
                  target="metadata">
        <name>
          <xsl:value-of select="geonet:i18n($suggest-iso19115-3_2018-schemaupgrade-loc, 'a', $guiLang)"/>
        </name>
        <operational>true</operational>
      </suggestion>
  </xsl:template>

<!-- based on core-geonetwork/schemas/iso19115-3.2018/src/main/plugin/iso19115-3.2018/convert/ISO19139/fromISO19139.xsl -->
    ...
    <xsl:include href="../../iso19115-3.2018/convert/ISO19139/mapping/core.xsl"/>
    <xsl:include href="../../iso19115-3.2018/convert/ISO19139/mapping/CI_ResponsibleParty.xsl"/>
    <xsl:include href="../../iso19115-3.2018/convert/ISO19139/mapping/CI_Citation.xsl"/>
    <xsl:include href="../../iso19115-3.2018/convert/ISO19139/mapping/SRV.xsl"/>
    <xsl:include href="../../iso19115-3.2018/convert/ISO19139/mapping/DQ.xsl"/>
